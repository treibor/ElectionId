...
import com.identity.views.ListView;
import com.identity.views.OfficeView;
...
public class MainLayout extends AppLayout {
	...
	private void createDrawer() {
		Icon employeeicon = new Icon(VaadinIcon.USER_STAR);
		Icon politicalicon = new Icon(VaadinIcon.USER);
		Icon printingicon =new Icon(VaadinIcon.PRINT);
		Icon masterdistrict =new Icon(VaadinIcon.ASTERISK);
		Icon officemaster= new Icon(VaadinIcon.ARROW_CIRCLE_RIGHT);
		Icon politicalmaster= new Icon(VaadinIcon.ARROW_CIRCLE_LEFT);
		//RouterLink listView=new RouterLink(" Election Personnel", ListView.class);
		RouterLink listView=new RouterLink();
		RouterLink printView=new RouterLink();
		RouterLink politicalView=new RouterLink();
		RouterLink officeView=new RouterLink();
		RouterLink masterDistrictView=new RouterLink();
		RouterLink politicalMasterView=new RouterLink();
		listView.add(employeeicon);
		listView.add(" Election Personnel");
		listView.setRoute(ListView.class);
		//RouterLink printView=new RouterLink("Printing & Reports", PrintView2.class);
		printView.add(printingicon);
		printView.add(" Printing & Reports");
		printView.setRoute(PrintView2.class);
		//RouterLink officeView=new RouterLink("Master- Offices & Cells", OfficeView.class);
		//RouterLink masterDistrictView=new RouterLink("Master- Printing", MasterDistrictView.class);
		//RouterLink politicalMasterView=new RouterLink("Master- Political Agents", PoliticalMasterView.class);
		//RouterLink politicalView=new RouterLink("Political Agents", PoliticalView.class);
		politicalView.add(politicalicon);
		politicalView.add(" Political Agents");
		politicalView.setRoute(PoliticalView.class);
		listView.setHighlightCondition(HighlightConditions.sameLocation());
		officeView.add(officemaster);
		officeView.add(" Master- Offices & Cells");
		officeView.setRoute(OfficeView.class);
		masterDistrictView.add(masterdistrict);
		masterDistrictView.add(" Master- Printing");
		masterDistrictView.setRoute(MasterDistrictView.class);
		politicalMasterView.add(politicalmaster);
		politicalMasterView.add(" Master- Political Agents");
		politicalMasterView.setRoute(PoliticalMasterView.class);
		addToDrawer(new VerticalLayout(listView, politicalView, masterDistrictView, officeView,  politicalMasterView, printView));
	}
	...
	private void saveNewUser() {
		...
		if (district.getValue() == null || state.getValue() == null || usertype.getValue() == null
			...
			notify.show("Wat Leh Shalak Ho Lok. Enter All Values, Please", 3000, Position.TOP_CENTER);
