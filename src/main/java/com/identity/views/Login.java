...
import com.identity.security.AuthenticatedUser;
import com.identity.util.Captcha;
import com.identity.util.CapthaImpl;
...
public class Login extends VerticalLayout implements BeforeEnterObserver {
	...
	H3 title = new H3("MegId Application");
	...
	public Login(AuthenticatedUser authenticatedUser) {
		...
		//getStyle().set("background", "url('images/background.jpg') no-repeat center center fixed");
	...
	private Component createPasswordForm() {
		...
		anchor.getStyle().set("color", "DarkCyan").set("padding-bottom", "20px");
		...
		header.getStyle().set("background-color", "DarkCyan");
